...
metrics["numbackends"] = {id:"483:Backends Connected:7",ratio:false, type:"QUERY_STAT_DATABASE"};
metrics["xact_commit"] = {id:"484:Transactions Committed:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["xact_rollback"] = {id:"485:Transactions Rolled Back:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["blks_read"] = {id:"486:Blocks Read:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["blks_hit"] = {id:"487:Blocks Hit:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["tup_returned"] = {id:"488:Rows Returned:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["tup_fetched"] = {id:"489:Rows Fetched:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["tup_inserted"] = {id:"490:Rows Inserted:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["tup_updated"] = {id:"491:Rows Updated:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["tup_deleted"] = {id:"492:Rows Deleted:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["deadlocks"] = {id:"493:Deadlocks:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["temp_files"] = {id:"494:Temporary Files:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["temp_bytes"] = {id:"495:Size of Temporary Files:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["blk_read_time"] = {id:"496:Bulk Read Time:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["blk_write_time"] = {id:"497:Bulk Write Time:7",ratio:true, type:"QUERY_STAT_DATABASE"};
metrics["confl_tablespace"] = {id:"498:Tablespace Conflicts:7",ratio:true, type:"QUERY_STAT_DATABASE_CONFLICTS"};
metrics["confl_lock"] = {id:"499:Lock Conflicts:7",ratio:true, type:"QUERY_STAT_DATABASE_CONFLICTS"};
metrics["confl_snapshot"] = {id:"500:Snapshot Conflicts:7",ratio:true, type:"QUERY_STAT_DATABASE_CONFLICTS"};
metrics["confl_bufferpin"] = {id:"501:Bufferpin Conflicts:7",ratio:true, type:"QUERY_STAT_DATABASE_CONFLICTS"};
metrics["confl_deadlock"] = {id:"502:Deadlock Conflicts:7",ratio:true, type:"QUERY_STAT_DATABASE_CONFLICTS"}; 
metrics["pg_database_size"] = {id:"503:Disk Space Used:7",ratio:false, type:"QUERY_STAT_DATABASE_SIZE"};
